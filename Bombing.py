...
def banner():
  ...
  /     \_______  \__    ___/____  |  | |  |__ _____    
 /  \ /  \_  __ \   |    |  \__  \ |  | |  |  \\__  \   
/    Y    \  | \/   |    |   / __ \|  |_|   Y  \/ __ \_ 
\____|__  /__|      |____|  (____  /____/___|  (____  / 
        \/                       \/          \/     \/  
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To hmabutalha933@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
...
if not cc.strip() == "91":
    if type == 1:
        print(
            '\t\tSorry But Call Bombing is Currently Supported Only For Bangladesh Numbers!!!!')
        print()
        input('Press Enter To Exit....')
        print('\n\n')
        banner()
